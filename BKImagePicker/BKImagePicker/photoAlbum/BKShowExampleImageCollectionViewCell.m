...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _imageScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(10, 0, frame.size.width-10*2, frame.size.height)];
        _imageScrollView.showsHorizontalScrollIndicator = NO;
        _imageScrollView.showsVerticalScrollIndicator = NO;
        _imageScrollView.delegate=self;
        _imageScrollView.contentSize = CGSizeMake(frame.size.width-10*2, frame.size.height);
...
-(void)scrollViewScale
{
    ...
    center.x = _showImageView.frame.size.width>_imageScrollView.frame.size.width?_imageScrollView.contentSize.width/2.0f:_imageScrollView.center.x-10;
