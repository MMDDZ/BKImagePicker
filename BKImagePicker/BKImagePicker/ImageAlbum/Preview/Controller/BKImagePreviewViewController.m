...
-(UIButton*)editBtn
{
    if (!_editBtn) {
        ...
        _editBtn.frame = CGRectMake(0, 0, self.view.bk_width / 6, BKImagePicker_get_system_tabbar_ui_height());
...
{
    if (!_originalBtn) {
        _originalBtn = [[BKImageOriginalButton alloc] initWithFrame:CGRectMake(BK_SCREENW/6, 0, BK_SCREENW/7*3, BKImagePicker_get_system_tabbar_ui_height())];
        [self calculataImageSizeWithSelectIndex:INT_MAX];
