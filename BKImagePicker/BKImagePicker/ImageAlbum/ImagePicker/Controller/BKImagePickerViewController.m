...
-(UICollectionView*)albumCollectionView
{
    if (!_albumCollectionView) {
        ...
        _albumCollectionView.scrollIndicatorInsets = UIEdgeInsetsMake(BKImagePicker_get_system_nav_height(), 0, 0, 0);
        _albumCollectionView.contentInset = UIEdgeInsetsMake(BKImagePicker_get_system_nav_height(), 0, 0, 0);
...
-(void)initTopNav
{
    BKImagePickerNavButton * rightNavBtn = [[BKImagePickerNavButton alloc] initWithTitle:@"取消" font:[UIFont systemFontOfSize:16] titleColor:BKNavBtnTitleColor];
...
-(UIButton*)previewBtn
{
    if (!_previewBtn) {
        ...
        _previewBtn.frame = CGRectMake(0, 0, self.view.bk_width/6, BKImagePicker_get_system_tabbar_ui_height());
...
{
    if (!_originalBtn) {
        _originalBtn = [[BKImageOriginalButton alloc]initWithFrame:CGRectMake(self.view.bk_width/6, 0, self.view.bk_width/7*3, BKImagePicker_get_system_tabbar_ui_height())];
        [self calculataImageSize];
